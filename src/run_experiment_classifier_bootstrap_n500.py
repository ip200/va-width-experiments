...
try:
    from utils import clip01, true_probability_1d, set_seed, extract_va_outputs
except ImportError:
    from src.utils import clip01, true_probability_1d, set_seed, extract_va_outputs
...
def run_classifier_bootstrap_experiment(
    ...
    p0, p1, p_mid, p_va, w = extract_va_outputs(pred_test)
    ...
    for m in range(M):
        ...
        _, _, mid_b, _, _ = extract_va_outputs(pred_b)
        boot_preds[m, :] = mid_b
